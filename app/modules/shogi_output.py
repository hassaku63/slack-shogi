...
koma2emoji = {
    Koma.empty: emoji_separetor + emoji_prefix + "blank" + emoji_separetor,
    Koma.fu: emoji_separetor + emoji_prefix + "pawn" + emoji_separetor,
    Koma.kyosha: emoji_separetor + emoji_prefix + "lance" + emoji_separetor,
    Koma.keima: emoji_separetor + emoji_prefix + "knight" + emoji_separetor,
    Koma.gin: emoji_separetor + emoji_prefix + "silver" + emoji_separetor,
    Koma.kin: emoji_separetor + emoji_prefix + "gold" + emoji_separetor,
    Koma.kaku: emoji_separetor + emoji_prefix + "bishop" + emoji_separetor,
    Koma.hisha: emoji_separetor + emoji_prefix + "rook" + emoji_separetor,
    Koma.gyoku: emoji_separetor + emoji_prefix + "king" + emoji_separetor,
    Koma.promoted_fu: emoji_separetor + emoji_prefix + "_p_pawn" + emoji_separetor,
    Koma.promoted_kyosha: emoji_separetor + emoji_prefix + "_p_lance" + emoji_separetor,
    Koma.promoted_keima: emoji_separetor + emoji_prefix + "_p_knight" + emoji_separetor,
    Koma.promoted_gin: emoji_separetor + emoji_prefix + "_p_silver" + emoji_separetor,
    Koma.promoted_kaku: emoji_separetor + emoji_prefix + "horse" + emoji_separetor,
    ...
    Koma.opponent_kaku: emoji_separetor + emoji_prefix + "bishop_" + emoji_separetor,
    ...
    Koma.opponent_promoted_hisha: emoji_separetor + emoji_prefix + "dragon_" + emoji_separetor,
}
